 ...
 */
function paragraphs(paragraphCount = 1, sentencesPerParagraph = null, startWithLorem = true) {
  ...
  for (let p = 0; p < paragraphCount; p++) {
    const sentences = [];
    const numSentences = sentencesPerParagraph || (Math.floor(Math.random() * 4) + 3); // 3-6 sentences
